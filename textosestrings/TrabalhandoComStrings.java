...
public class TrabalhandoComStrings {
	...
	public static void main(String[] args) {
		...
		// verificar se o valor é uma letra ou é um texto e retorna true ou false
		...
		System.out.println("=====================================================");
		// verfificar se o valor está escrito com caracter maiusculo
		System.out.println(Character.isUpperCase('c'));
		System.out.println(Character.isUpperCase('A'));

		System.out.println("=====================================================");
		// verificar se o valor está ecrito com caracter minusculo
		...
		// arquivo = arquivo.replace("escola.java","arquivo.class");
		...
		System.out.println("=====================================================");
		//retorna a posição da primeira ocorrencia de uma letra
